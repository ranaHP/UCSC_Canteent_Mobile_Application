...
import 'package:ucsc_canteen_19001355/student/shopping_cart.dart';
...
class _StudentFoodScreenState extends State<StudentFoodScreen> {
  ...
  List<FoodItem> _myshoppingcardItemList = [];
  final CollectionReference _collectionRef =
  ...
  Future<void> getData() async {
    ...
    FirebaseFirestore.instance
      ...
      if (documentSnapshot.exists) {
        ...
        try {
          setState(() {
            _myshoppingcardItemList = documentSnapshot.get(FieldPath(['item']));
          });
          print('Document data: $data');
        } on StateError catch (e) {
          print('No nested field exists!');
  ...
  Future getShoppinngcarddata() async {}
                          ...
                          ElevatedButton(
                              onPressed: () => {
                                    Navigator.pushReplacement(
                                        ...
                                        MaterialPageRoute(
                                            builder: (BuildContext context) =>
                                                const StudentShoopingCartcreen()))
                                  },
                              style: ElevatedButton.styleFrom(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Icon(Icons.shopping_cart,
                                        color: Colors.white),
                                    Text(
                                      'My Shopping Cart ${_myshoppingcardItemList.length}',
